...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Vd0ap4beSk)
...
```sh
npx nx serve performance-wealth-tracker
```

To create a production bundle:

```sh
npx nx build performance-wealth-tracker
```

To see all available targets to run for a project, run:

```sh
npx nx show project performance-wealth-tracker
```
